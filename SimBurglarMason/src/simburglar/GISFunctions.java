...
public class GISFunctions {
     ...
     *
     * @param g The geometry to search around
     * @param objects The list of objects to look for (must      * be <code>MasonGeometry</code> objects)
     * @param state The SimState object.
     * @return
     */
